                ...
                <nav className="navbar navbar-expand-lg p-0">
                    ...
                    <ul className="iconBar text-center">
                        <li className="list-inline-item">
                            <a className="reverse rounded-circle d-block" href="#" title><img src="images/refresh.png" alt="" /></a>
                        </li>
                        <li className="list-inline-item">
                            <a className="wishlist rounded-circle d-block" href="#" title><img src="images/wishlist.png" alt="" /></a>
                        </li>
                        <li className="list-inline-item">
                            <a className="cart rounded-circle d-block" href="#" title><img src="images/cart.png" alt="" /></a>
                        </li>
                        <li className="list-inline-item">
                            <div className="btn-group">
                                ...
                                <ul className="dropdown-menu shadow">
                                    ...
                                    <li className="fs-14 font-r text-color-2"><img className="d-inline-block" src="images/p-profile.png" alt="" /><a className="dropdown-item d-inline-block" href="#">Profile</a></li>
                                    ...
                                    <li className="fs-14 font-r text-color-2 "><img className="d-inline-block" src="images/order.png" alt="" /><a className="dropdown-item d-inline-block" href="#">Orders &amp; Returns</a></li>
                                    <li><hr className="dropdown-divider" /></li>
                                    ...
                                    <li className="fs-14 font-r text-color-2 "><img className="d-inline-block" src="images/map.png" alt="" /><a className="dropdown-item d-inline-block" href="#">Saved Addresses</a></li>
                                    <li><hr className="dropdown-divider" /></li>
