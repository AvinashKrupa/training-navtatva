...
function WishlistButton() {
  ...
  const wishItems = useWishlistStore((state: any) => state.wishlistItems, shallow);
  ...
  return (
    <li className="list-inline-item">
      {Object.entries(wishItems).length > 0 ? <Badge bg="danger">{Object.entries(wishItems).length}</Badge> : null}
