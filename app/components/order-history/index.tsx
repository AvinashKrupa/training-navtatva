                        ...
                        return (<>
                            <div className="row mb-3">
                                <div className="col-md-12 col-lg-9">
                                    <div className="row">
                                        ...
                                        <div className="col-md-12 col-lg-10 col-xl-6 mt-3">
                                            <a href="button" className="btn btn-green d-inline-block">
                                ...
                                <div className="col-md-12 col-lg-3 offet-1">
                                    <a href="button" className="btn btn-bor d-block mb-2 mt-2 mt-xl-0">
                                    ...
                                    <a href="button" className="btn btn-bor d-block mb-2">
                                    ...
                                    <a href="button" className="btn btn-bor d-block">
                            ...
                            <div className="row mb-3">
                                <div className="col-md-12 col-lg-9">
                                    <div className="row">
                                        ...
                                        <div className="col-md-12 col-lg-10 col-xl-6 mt-3">
                                            <a href="button" className="btn btn-gray d-inline-block">
                    ...
                    <div className="row">
                        <div className="col-md-12 col-lg-9">
                            <div className="row">
                                ...
                                <div className="col-md-12 col-lg-10 col-xl-6 mt-3">
                                    <a href="button" className="btn btn-red d-inline-block">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} fill="currentColor" className="bi bi-x-lg" viewBox="0 0 16 16">
                                            <path d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8 2.146 2.854Z" />
                                        </svg>
                                        Cancelled on 10th July
                                    </a>
                                </div>
                            </div>
                        </div>
