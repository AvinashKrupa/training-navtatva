        ...
        <div className="bgbar position-relative mt-4">
            <div className="row">
                <div className="form-check">
                    <input className="form-check-input" type="checkbox" defaultValue={""} id="flexCheckDefault" /> </div>
                ...
                <div className="col-md-9 position-relative">
                    ...
                    <div className="d-flex topBarAlign">
                        <p className="fs-16 font-sb text-color-2 align-self-center me-3">₹3,499</p>
