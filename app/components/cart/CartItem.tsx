        ...
        <div className="row">
          ...
          <div className="col-md-3 col-lg-3">
            <div className="imgbar ">
              <a href={Permalink.ofProduct(props)}><img className="w-100" src={props.image?.href} alt="" /></a>
            </div>
          </div>
          <div className="col-md-9 position-relative">
            <a href={Permalink.ofProduct(props)}><h3 className="fs-16 font-sb text-color-2">{props.name}</h3></a>
