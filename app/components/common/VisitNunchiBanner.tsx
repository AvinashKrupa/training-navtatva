        ...
        <div className="row">
          <div className="col-xl-5 mb-4 mb-xl-0 align-self-center">
            <div className="leftBar text-center text-xl-start">
              ...
              <a href="#" className="btn w-100 fs-20 mt-4"><span className="text-white me-2" style={{fontStyle: 'normal'}}>Visit</span><img src="images/Black.svg" alt="" /> Nunchi Jewellery</a>
            </div>
          </div>
          <div className="col-xl-7">
            <div className="row">
              <div className="col-md-4 overhead position-relative mb-4 mb-md-0">
                <img className="w-100 d-none d-md-block" src="images/jwelary-1.jpg" alt="" />
                <img className="w-100  d-block d-md-none" src="images/jwelary-1-m.jpg" alt="" />
                <h4 className="fs-14 text-color-2 font-m ">Bangles<span className="font-r d-block">Starting from ₹1299</span></h4>
              </div>
              <div className="col-md-4 overhead ">
                <div className="row">
                  <div className="col-md-12 h-100  position-relative  mb-4 mb-md-0">
                    ...
                    <h4 className="fs-14 text-color-2 font-m ">Ear Rings<span className="font-r d-block">Starting from ₹1299</span></h4>
                  </div>
              ...
              <div className="col-md-4 overhead position-relative  mt-4 mt-md-0">
                <img className="w-100 d-none d-md-block" src="images/jwelary-3.jpg" alt="" />
                <img className="w-100  d-block d-md-none" src="images/jwelary-3-m.jpg" alt="" />
                <h4 className="fs-14 text-color-2 font-m ">Ear Rings<span className="font-r d-block">Starting from ₹1299</span></h4>
              </div>
            </div>
          </div>
