...
import { CatalogService } from "../../../app/network/gateway/Catalog";
import Header from "../../../app/themes/themeOne/components/Header";
import ProductObj from "../../../app/utils/ProductObj";
import {
                      ...
                      <div className="row">
                        <div className="col-md-4">
                          <div className="discount-offer text-white">
                            <h4 className="fs-16 font-sb">{product?.getOffPercent()}% Discount</h4>
                        ...
                        <div className="col-md-4">
                          <img className="w-100" src={product?.getFeaturedImage()} alt={product?.getName()} />
                        </div>
                        <div className="col-md-4">
                          <div className="">
                            ...
                            <div className="custom-radios">
                              ...
                              {
                                product?.getColors().map( (item: any, index: number) => {
                                  return <div>
                                    <input
                                      type="radio"
                                      id={"color-"+index}
                                    ...
                                    <label htmlFor={"color-"+index}>
                                      <span style={{ background: item.description }}>
                                        <div title={item.name}/>
                                      </span>
                                    </label>
                                  </div>
                                    ...
                                    <tr>
                                      <td>
                                        ...
                                        <select className="form-select">
                                          {
                                            product?.getSizes().map((item: any, index: number) =>{
                                      ...
                                      <td>
                                        ...
                                        <select className="form-select">
                                          {
                                            product?.getQuantityList().map((item: any, index: number) =>{
                ...
                <ul>
                  <li className="list-inline-item valign">
                    <div className="d-flex">
                      <h4 className="fs-20 text-color-2">₹{product?.getPrice()}</h4>
                      <span className="fs-13 text-color-6">₹{product?.getOffAmount()} off ({product?.getOffPercent()}%)</span>
