...
const ProductDetailScreen: NextPage = () => {
  ...
  function getProductDetail(productId: any) {
    CatalogService.getInstance()
      .getProducDetail(productId)
      .then((response: any) => {
        if (response.data) {
                  ...
                  <Slider {...productDetailSliderSetting}>
                    <div>
                      <div className="row">
                        ...
                        <div className="col-md-4">
                          <img className="w-100" src={product?.attributes?.images?.length ? product?.attributes?.images[0]: "/images/detail-img.png"} alt={product?.name} />
                        </div>
                        <div className="col-md-4">
                          <div className="">
                            <h2 className="product-title fs-24 font-sb">{product?.name}</h2>
