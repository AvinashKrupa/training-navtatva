                        ...
                        <div className="row">
                            ...
                            <div className="col-12 col-lg-8 col-xl-9 mb-5">
                                <div className="rightside-bar-area">
                                    ...
                                    {loading &&
                                        <Loader />}
                                    {!loading && <><h3 className="username">Welcome back, <b className="text-primary">  {customerData?.data.userDetails.name}</b></h3>
                                        <div className="varification-box text-white">
                                            <h5 className="mb-2">Pending e-mail Verification</h5>
                                            <p>Complete e-mail verification within the next 24 hours to finish setting up your account. </p>
                                                    ...
                                                    <div className="row">
                                                        <div className="col-12 col-sm-6">
                                                            <div className="form-group">
                                                                <label>Name</label>
                                                                <input type="text" className="form-control" placeholder=" " value={customerData?.data.userDetails.name} />
                                                            </div>
                                                        </div>
                                                        <div className="col-12 col-sm-6">
                                                            <div className="form-group">
                                                        ...
                                                        <div className="col-12 col-sm-6">
                                                            <div className="form-group">
                                                                <label>E-mail</label>
                                                                <input type="email" className="form-control" placeholder="" value={customerData?.data.userDetails.email} />
                                                            </div>
                                                        </div>
                                                        <div className="col-12 col-sm-6">
                                                            <div className="form-group">
